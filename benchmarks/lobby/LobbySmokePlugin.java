...
public final class LobbySmokePlugin extends JavaPlugin {
    ...
    private void tick() throws Exception {
        ...
        if (stage==0) {
            ...
            require(first.getOpenInventory().getTopInventory().getSize()==54,"BGM manager has six rows");
            require(first.getOpenInventory().getTopInventory().getItem(49).getType()==Material.HOPPER,"BGM upload at bottom center");
            require(first.getOpenInventory().getTopInventory().getItem(53).getType()==Material.BOOK,"BGM library at bottom right");
