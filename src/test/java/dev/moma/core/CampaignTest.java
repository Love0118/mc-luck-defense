...
class CampaignTest {
    ...
    @Test void preparationSpawnsAndRoundBoundariesAreExactAndSurvivorsPersist() {
        CampaignRules rules = new CampaignRules(5, 100, 1000, 3, 100, 100, 1);
    ...
    @Test void clearingEverySpawnWinsOnlyAfterAll100Waves() {
        CampaignRules rules = new CampaignRules(5, 100, 100, 0, 100, 100, 1);
    ...
    @Test void finalEnemyMustDieBeforeCleanupDeadline() {
        CampaignRules rules = new CampaignRules(5, 100, 10_000, 0, 100, 40, 1);
    ...
    @Test void failedSpawnDoesNotAdvanceSpawnCursorAndEndedArenaDoesNotSpawn() {
        var rules = new CampaignRules(5, 100, 2, 0, 100, 40, 1);
