...
final class SessionTools {
    ...
    void give(Player player) {
        ...
        data.set(backupKey,PersistentDataType.BYTE_ARRAY,ItemStack.serializeItemsAsBytes(new ItemStack[]{inventory.getItem(0),inventory.getItem(1)}));
    ...
    void restore(Player player) {
        ...
        if(previous!=null && previous.length!=2)throw new IllegalStateException("Invalid session hotbar backup for "+player.getUniqueId());
